...
export const resultProfiles: ResultProfile[] = [
  {
    ...
    description:
      'Z Twoich odpowiedzi wyłania się fascynujący i bardzo konkretny obraz neurobiologiczny. Obserwowany upór, nagłe wybuchy czy rzekoma \u201Ekrnąbrność\u201D Twojego dziecka to nie błędy wychowawcze. To namacalny dowód na to, że w jego mózgu dominuje obecnie tzw. przetwarzanie impulsywne (bottom-up). Co to oznacza? Sygnały z jego układu emocjonalnego wyprzedzają jeszcze niedojrzałe sieci hamujące w korze przedczołowej. Twoje dziecko w momentach kryzysu nie odmawia współpracy ze złośliwości \u2013 ono po prostu nie jest w stanie przetworzyć kolejnego bodźca. Zamiast eskalacji dyscypliny, despercko potrzebuje zjawiska \u201Edebugowania środowiska\u201D, a Ty musisz na chwilę stać się jego zewnętrzną korą przedczołową.',
  ...
  },
  {
    ...
    description:
      "Uzyskane przez Ciebie parametry są wyjątkowe. Jako rodzic-architekt wypracowałeś bezbłędną optymalizację okien neuroplastyczności u swojego dziecka. Profil Logicznego Stratega oznacza, że w jego architekturze wykształciła się silna autonomia sieci wykonawczych (top-down processing). Twoje dziecko skutecznie filtruje bodźce, blokuje pierwotne impulsy i rygorystycznie monitoruje własne zachowanie. Stoisz teraz przed zupełnie nowym, fascynującym wyzwaniem. Tradycyjna stymulacja to dla niego za mało – brak odpowiedniego, inteligentnego wyzwania poznawczego może prowadzić do znużenia i demotywacji. Twoje dziecko jest w optymalnym punkcie startowym do budowy najwyższych przewag kognitywnych.",
