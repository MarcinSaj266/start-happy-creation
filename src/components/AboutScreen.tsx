      ...
      <div className="w-full max-w-5xl">
        ...
        <motion.div
          ...
          <div className="md:col-span-3 text-center md:text-left">
            <p className="text-sm font-bold uppercase tracking-widest text-muted-foreground mb-3">OPARTE NA DOWODACH NAUKOWYCH

            </p>

            <h1 className="text-4xl md:text-5xl font-bold text-foreground mb-6 leading-tight">Poznaj Logigłówkę

            </h1>

            <p className="text-lg leading-relaxed text-foreground/80 mb-8">Logigłówka powstała z myślą o świadomych rodzicach, którzy chcą wspierać rozwój poznawczy dzieci w oparciu o rzetelną wiedzę, a nie przypadkowe porady. 


Przekładamy skomplikowane procesy zachodzące w mózgu dziecka na konkretne, proste do wdrożenia kroki. Pomagamy budować kapitał intelektualny od najmłodszych lat.
